...
<head>
    ...
    <link rel="stylesheet" href="/mohinhmvc/public/css/font-awesome.min.css" type="text/css" />
    <link rel="stylesheet" type="text/css" href="/mohinhmvc/public/css/owl.carousel.min.css">
      <link rel="stylesheet" type="text/css" href="/mohinhmvc/public/css/owl.theme.default.min.css">
      <link rel="stylesheet" type="text/css" href="/mohinhmvc/public/css/product.css">
    <link rel="stylesheet" type="text/css" href="/mohinhmvc/public/css/style.css">
        ...
        <div class="header_top_menu">
            <div class="header_top_menu_all">
                <div class="header_top">
                    <div class="bg_in">
                        <div class="logo">
                            <a href="/mohinhmvc/trangweb/index"><img src="/mohinhmvc/public/image/logohere.jpeg" width="250" height="100" alt="logohere.jpeg" /></a>
                        </div>
                        <nav class="menu_top">
                ...
                <div class="bg_in">
                    <div class="table_row_search">
                                        ...
                                        <div id='cssmenu_flyout' class="display_destop_menu">
                                            ...
                                            ?>
                                                <li class='active has-sub'>
                                                    <a href='/mohinhmvc/trangweb/danhmuc_sp/<?php echo $row["cat_id"] ?>'><span><?php echo $row["cat_name"] ?></span></a>
                                                    <!-- <div class="menu_sub_all">
                                                        <span style="color: #000;position: relative;font-size: 17px;font-weight: 700;">Apple</span>
                                                        <ul>
                                                            <li>
                                                                <a href="/mohinhmvc/trangweb/danhmuc_sp">Iphone X</a>
                                                            </li>
                        ...
                        <div class="search_top">
                            <div id='cssmenu'>
                                <ul>
                                    <li class='active'><a href='/mohinhmvc/trangweb/index'>Trang chủ</a></li>
                                    <li class=''><a href='chitiettin.php'>Giới thiệu</a></li>
                                    
                                    <li class=''>

                                        <a href='/mohinhmvc/trangweb/sanpham'>Sản phẩm</a>

                                        <ul>
                                        <?php 
                                         foreach($data["getdm"] as $dmsp){
                                        ?>
                                            <li>
                                            <a href='/mohinhmvc/trangweb/danhmuc_sp/<?php echo $dmsp["cat_id"] ?>'><?php echo $dmsp["cat_name"] ?></a>
                                            </li>
                                        <?php
                                        }
                                        ?>
                                    ...
                                    <li class=''><a href='/mohinhmvc/trangweb/lienhe'>Liên hệ</a></li>
                                    <li class=''><a href='/mohinhmvc/trangweb/giohang'>Giỏ hàng</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="clear"></div>
