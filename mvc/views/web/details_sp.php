            ...
            <div class="content_page">
               <div class="content-right-items margin0">
                  <div class="title-pro-des-ct">
                     <h1><?php echo $row["title_sanpham"] ?></h1>
                  </div>
                  <div class="slider-galery ">
                     <div id="sync1" class="owl-carousel owl-theme">
                        <div class="item">
                           <img src="/mohinhmvc/public/image/iphone1.jpg " width="100%">
                        </div>
                        <div class="item">
                           <img src="/mohinhmvc/public/image/iphone1.jpg" width="100%">
                        </div>
                        <div class="item">
                           <img src="/mohinhmvc/public/image/iphonex.png" width="100%">
                        </div>
                     </div>
                     <div id="sync2" class="owl-carousel owl-theme">
                        <div class="item">
                           <img src="/mohinhmvc/public/image/iphone.png" width="100%">
                        </div>
                        <div class="item">
                           <img src="/mohinhmvc/public/image/iphone1.jpg" width="100%">
                        </div>
                  ...
                  <div class="content-des-pro">
                     <div class="content-des-pro_in">
                        <div class="pro-des-sum">
                           ...
                           <div class="color_price">
                              <span class="title_price bg_green">Giá bán</span> <?php echo number_format($row["price_sanpham"],0,',','.').'  '.'VND'  ?>  (GIÁ CHƯA VAT)
                              <div class="clear"></div>
                           </div>
                           <div class="color_price">
                     ...
                     <div class="content-pro-des">
                        <div class="content_des">
                           <p style="font-size: 16px;font-weight: bold;"><?php echo $row["title_sanpham"] ?></p>
                           <br />
                  ...
                  <div class="content-des-pro-suport">
                     ...
                     <div class="bx-contact">
                        ...
                        <p><img alt="icon skype " src="/mohinhmvc/public/image/icon skype.png" style="height:24px; width:24px" />&nbsp;<a href="skype:quangtran.123corp?chat">thietbivanphong.com</a></p>
                        <p><img alt="icon skype " src="/mohinhmvc/public/image/icon skype.png" style="height:24px; width:24px" />&nbsp;<a href="skype:quangtran.123corp?chat">thietbivanphong.com</a></p>
                        <p><img alt="icon skype " src="/mohinhmvc/public/image/icon skype.png" style="height:24px; width:24px" />&nbsp;<a href="skype:quangtran.123corp?chat">thietbivanphong.com</a></p>
            ...
            <div class="module_pro_all">
               ...
               <div class="pro_all_gird">
                  <div class="girds_all list_all_other_page ">
                     <?php
                     foreach($data['sp_lq'] as $key => $splq){
                     ?>
                     <div class="grids">
                        <div class="grids_in">
                           <div class="content">
                              <div class="img-right-pro">
                                 <a href="/mohinhmvc/trangweb/danhmuc_sp/<?php echo $splq['id_sanpham'] ?>">
                                 <img class="lazy img-pro content-image" src="/mohinhmvc/public/uploads/img_sanpham/<?php echo $splq["image_sanpham"]?>" data-original="image/iphone.png" alt="Máy in Canon MF229DW" />
                                 </a>
                              ...
                              <div class="name-pro-right">
                                <a href="/mohinhmvc/trangweb/chitiet_sp/<?php echo $splq['id_sanpham'] ?>">
                                   <h3><?php echo $splq['title_sanpham'] ?></h3>
                               </a>
                              </div>
                              <div class="add_card">
                              ...
                              <div class="price">
                                <span class="news_price"><?php echo number_format($splq["price_sanpham"],0,',','.').'VND'  ?></span>
                            </div>
                              </div>
                           </div>
                        </div>
