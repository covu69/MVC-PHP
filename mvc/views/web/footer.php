<footer>
            ...
            <div class="bg_in">
               <div class="footer footer_bottom">
                  ...
                  <div class="footer-col">
                     ...
                     <div class="footer-col-content">
                        <ul class="social">
                           <li><a href="" class="fb"><img src="/mohinhmvc/public/image/Fb.png">Facebook</a></li>
                           <li><a href="#2" class="fb"><img src="/mohinhmvc/public/mage/Fb.png">Google</a></li>
                        </ul>
                        <div class="clear"></div>
                     </div>
                  </div>
            ...
            <div class="bg_in">
               <div class="footer">
                  <div class="infor_company">
                     ...
                     <a href=""><img src="/mohinhmvc/public/image/da-dang-ky-voi-bo-cong-thuong.png"  alt="da-dang-ky-voi-bo-cong-thuong.png" class="cangiua" /></a>
      ...
      <div class="coccoc-alo-phone coccoc-alo-green coccoc-alo-show" id="coccoc-alo-phoneIcon" >
       ...
       <link async rel="stylesheet" href="/mohinhmvc/public/css/cssfooter.css"/>
      <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
      
      <script defer type="text/javascript" src="/mohinhmvc/public/js/sweet-alert.js"></script>
      <script defer type="text/javascript" src="/mohinhmvc/public/js/jquery.flexslider-min.js"></script>
      <script defer src="/mohinhmvc/public/js/owl.carousel.js" type="text/javascript"></script>
      <script defer src="/mohinhmvc/public/js/jquery.lazyload.min.js" type="text/javascript"></script>
      <script defer type="text/javascript" src="/mohinhmvc/public/js/script_ex.js"></script>
      <script defer type="text/javascript" src="/mohinhmvc/public/js/script_menu.js"></script>
    ...
    <script type="text/javascript">
      ...
      <div style="display: none;left: 70%;margin-left: -309px;z-index: 1002;position: fixed;top: 40%;margin-top: 0px;" id="loadding">
         <img src="/mohinhmvc/public/image/loader.gif" />
      </div>
   </body>
</html>